                        ...
                        <form className="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg" onSubmit={onSubmit}>
                            ...
                            <div>
                             ...
                             <div>
                                ...
                                <SelectInput value={data.project_id} id="task_project_id" name="project_id" className="mt-1 block w-full" onChange={e => setData('project_id', e.target.value)}>
                            ...
                            <div className="mt-4">
                                ...
                                <SelectInput value={data.status} id="task_status" name="status" className="mt-1 block w-full" onChange={e => setData('status', e.target.value)}>
                            ...
                            <div className="mt-4">
                                ...
                                <SelectInput value={data.priority} id="task_priority" name="priority" className="mt-1 block w-full" onChange={e => setData('priority', e.target.value)}>
                            ...
                            <div className="mt-4">
                                ...
                                <SelectInput value={data.assigned_user_id} id="task_assigned_user" name="assigned_user_id" className="mt-1 block w-full" onChange={e => setData('assigned_user_id', e.target.value)}>
